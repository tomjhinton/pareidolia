...
void main(){
  ...
  vec2 rote2 = rotateUV(uv, vec2(.5), -PI * sin(vTime) * .05 );
  ...
  // pMod2(uv, );
  color.r = stroke(snoise(rote * v_16 ),
  .2 +wiggly(roteC.x + vTime * .005, roteC.y + vTime * .005, .2, 6. , .5  ) , .2 );

  color.g = stroke(snoise(rote * v_17 ),
  .2 +wiggly(roteC.x + vTime * .005, roteC.y + vTime * .005, .2, 6. , .5  ) , .2 );

  color.b = stroke(snoise(rote * v_18 ),
  .2 +wiggly(roteC.x + vTime * .005, roteC.y + vTime * .005, .2, 6. , .5  ) * v_19 , .2 );


  color = mix(color, 1.-color, stroke(cnoise(vec2(smoothstep(.1
    +wiggly(roteC.x + vTime * .005, roteC.y + vTime * .005, .2, 6. , 1.5   ),
     .5 + wiggly(roteC.x + vTime * .005, roteC.y + vTime * .005, .2, 6. , 1.5  ), sin(vTime) ), .2 ) * 1. ),
  .2 +wiggly(uv.x + vTime * .005, uv.y + vTime * .005, .2, 6. , .5  ) , .4 ) );
